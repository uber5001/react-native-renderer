...
xctool -project dist/dist.xcodeproj/ -scheme dist -sdk iphonesimulator8.1 clean CONFIGURATION_BUILD_DIR=$(pwd)/dist/build
xctool -project dist/dist.xcodeproj/ -scheme dist -sdk iphonesimulator8.1 build CONFIGURATION_BUILD_DIR=$(pwd)/dist/build
